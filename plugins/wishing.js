...
asena.addCommand({pattern: 'gm', fromMe: true, deleteCommand: true, desc: GM,}, (async (message, match) => {
    ...
    r_text[1] = "♡︎..𝙷𝙸..𝙴𝚅𝙰𝙳𝙴..𝙰𝙻𝙻𝙰𝚅𝙰𝚁𝚄𝙼..𝚂𝙰𝙽𝙰..𝙼𝚆𝙾𝙻..𝚄𝚁𝙰𝙽𝙶𝙸..𝙴𝙽𝙽𝙴𝚃𝚄..𝙽𝙸𝙽𝙶𝙰𝙻..𝙸𝙿𝙿𝙰𝚈𝚄𝙼..𝚄𝚁𝙰𝙽𝙶𝙰𝙽𝙾..𝙴𝙻𝙻𝙰𝚁𝙺𝙺𝚄𝙼..𝙾𝚁𝚄..𝙽𝙰𝙻𝙻𝙰..𝙶𝙾𝙾𝙳..𝙼𝙾𝙽𝙸𝙽𝙶..♡︎";
...
asena.addCommand({pattern: 'gn8', fromMe: true, deleteCommand: true, desc: GN,}, (async (message, match) => {

        var r_text = new Array ();

        r_text[1] = "𝚂𝙰𝙽𝙰 𝙼𝚆𝙾𝙻 𝚄𝚁𝙰𝙽𝙶𝙰𝙽 𝙿𝙾𝙺𝙰𝙽 𝙶𝙾𝙾𝙳 𝙽𝙸𝙶𝚃𝙷✨";
