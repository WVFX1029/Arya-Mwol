...
module.exports = {
    ...
    OWNER: process.env.OWNER_NAME === undefined ? 'SANA' : process.env.OWNER_NAME,
    ...
    BOTSANA: process.env.BOT_NAME === undefined ? '  Sana Mwol   \n\n   *𝒘𝒉𝒂𝒕𝒔𝒂𝒑𝒑 𝒃𝒐𝒕™*   \n' : process.env.BOT_NAME,
    ...
    OWNERSHIP: process.env.OWNER_SHIP === undefined ? 'SANA' : process.env.OWNER_SHIP,
    SABA: process.env.LOGO_LINK === undefined ? 'https://i.imgur.com/2nYs8dN.jpg' : process.env.LOGO_LINK,
    SER: process.env.BGM_DURATION === undefined ? '99999935' : process.env.BGM_DURATION,
    BOTV2: process.env.BOTV2_NAME === undefined ? 'SANA' : process.env.BOTV2_NAME,
    SANA_AI: process.env.SANA_AI === undefined ? 'false' : process.env.SANA_AI,
    ...
    LOGO_NAME: process.env.LOGO_NAME === undefined ? 'SANA' : process.env.LOGO_NAME,
